...
<div class="h-full flex flex-col gap-4">
    <div class="prose max-w-[100%]">
        ...
        <p>ref: https://britishwildlifecentre.co.uk/planyourvisit/animals/</p>
        <p>Or use content from this page https://britishwildlifecentre.co.uk/planyourvisit/your-visit/</p>
    </div>
